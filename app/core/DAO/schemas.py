...
class OrderHead(BaseModel):
    ...
    date: str = Field(DATE_THREE, description="Дата создания документа")
    dateShipment: str = Field(DATE_THREE, description="[!..Уточник..!]")
    ...
    is_new: bool = Field(..., description="Статус новизны товара")
